...
func (plugin *Plugin) setupEgressRules(iptable *iptables.IPTables,
	config *config.NetConfig,
	egressIgnoredIPs string) error {
...
func (plugin *Plugin) setupIngressRules(iptable *iptables.IPTables,
...
func (plugin *Plugin) deleteIptablesRules(proto iptables.Protocol,
	config *config.NetConfig) error {
...
func (plugin *Plugin) deleteIngressRules(iptable *iptables.IPTables,
	config *config.NetConfig) error {
	if config.ProxyIngressPort == "" {
		return nil
	}
